...
class InUseReport(ListView):
    ...
    def get_context_data(self, **kwargs):
        ...
        users = UserOrganizationConnection.objects.filter(organization=organization).values_list(
            "user"
        )
...
class BrokenReport(ListView):
    ...
    def get_context_data(self, **kwargs):
        context = super().get_context_data(**kwargs)
        context["organization_title"] = UserOrganizationConnection.objects.get(
