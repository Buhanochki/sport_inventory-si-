...
class AdminNoOrganization(CreateView):
    ...
    def get(self, request, *args, **kwargs):
        ...
        if request.user.status != "TC" or UserOrganizationConnection.objects.filter(user=request.user):
    ...
    def form_valid(self, form):
        ...
        organization.save()
        UserOrganizationConnection.objects.create(user=self.request.user, organization=organization).save
